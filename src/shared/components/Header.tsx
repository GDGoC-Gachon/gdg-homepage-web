...
function Header() {
    ...
    return (
        <div className="fixed w-full h-[4.125rem] bg-mainWhite flex items-center z-50">
            ...
            <button className="ml-16 font-productSans hover:text-mainRed transition-all duration-200 ease-in-out"
                    onClick={() => navigate("/")}>Introduce</button>
            <button className="ml-16 font-productSans hover:text-mainRed transition-all duration-200 ease-in-out"
                    onClick={() => navigate("/recruitment")}>Recruitment</button>
            <button className="ml-16 font-productSans hover:text-mainRed transition-all duration-200 ease-in-out"
