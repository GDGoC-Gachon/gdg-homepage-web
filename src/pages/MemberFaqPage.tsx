...
import { ReactComponent as FaqIcon } from '../shared/assets/icons/common/memberFaqIcon.svg';
          ...
          <div className="px-10 pt-12 pb-6 mb-2 w-full rounded-xl flex-center flex-col gap-8 bg-[#FFF] shadow-lg">
            <div className='w-full flex gap-8'>
              ...
              <input
                ...
                className='p-2 border-[1px] border-[#E7EAEE] rounded-sm flex-1 bg-[#F7F8F9] text-sm focus:outline-none'
              />
            </div>
            <div className='w-full flex gap-8'>
