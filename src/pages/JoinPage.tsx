...
function JoinPage() {
  ...
  return (
    <>
      <div className="fixed top-[8.375rem] right-[6.25rem] z-50">
        <JoinButton color="#DAE8FF" font_color="#4285F4">
          <FontAwesomeIcon icon={faPaperPlane} color="#4285F4" width={26} />
          <span className="ml-[10px]">신청서 작성하러 바로가기</span>
        </JoinButton>
      </div>
      <div className="flex flex-col justify-between">
        <div className="h-[20rem] bg-[#F1F3F4] w-[100vw]"></div>
        <div className="w-full h-[3006px] flex flex-col items-center justify-center gap-[18.75rem] bg-joinBg bg-cover min-w-[100vw]">
          <ScheduleSection />
          <TargetSection />
          <BenefitSection />
          <div className="flex justify-center w-full mb-20">
            <JoinButton color="#F1F3F4" font_color="#4285F4">
              신청서 작성하러가기
            </JoinButton>
          </div>
        </div>
